...
cd /root/XMFnet-2080ti/decoder/utils/metrics/pytorch_structural_losses
make

# https://github.com/sshaoshuai/Pointnet2.PyTorch
cd /root/XMFnet-2080ti/decoder/utils/Pointnet2.PyTorch/pointnet2
python3 setup.py install

# https://github.com/daerduoCarey/PyTorchEMD
cd /root/XMFnet-2080ti/decoder/utils/PyTorchEMD
python3 setup.py install

# used to generate partialized partial inputs
cd /root/XMFnet-2080ti/decoder/utils/randPartial
python3 setup.py install
